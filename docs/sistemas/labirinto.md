...
## V2-A.1 — polish estrutural (12/09, manhã)
Backup `ServerStorage/_Backup_2026-09-12_preV2A1_polish` (Map, Gameplay, Terrain_all).
- **Performance real (janela em foco, Play, 60 s por área, lanterna acesa, câmera girando)**: Acampamento min 48 / média 52 / estável 55 · Entrada 45 / 49,5 / 51,5 · **S1 60/60/60 · S2 58/60/60 · S3 60/60/60 · FinalGateArea 46 (carga) / 59,8 / 60**. Causa dos ~50 no acampamento isolada por teste A/B em Play: **floresta do acampamento (1.071 pinheiros em campo aberto) → sem ela 60 fps**; sombras, partículas, VHS, blur e props mudam < 2 fps. Ação: floresta do acampamento **afinada de 1.071 → 427** (644 arquivadas em `_Archive_2026-09-12_CampForestThinned`; anel < 80 studs intacto, cristas da aproximação protegidas; 173 árvores restantes escaladas ×1,08–1,18 para fechar a cortina). Re-medição com foco ficou pendente (a segunda rodada caiu em throttle de 15 fps por perda de foco).
- **Paredes (S1/S2/gate)**: 47 sequências retas detectadas (`Layout.StraightRuns`); aplicado em S1/S2: **10 "jogs"** (blocos de rocha r 5–7 em nós de grau 2, lado alternado, passagem ≥ 15 verificada por voxels, `Layout.PolishJogs`) + 8 pinheiros junto aos jogs, **94 reentrâncias** de piso (alcovas r 4,5–6,5 com chão de terra), **59 elevações + 62 rebaixos de crista** (variação de altura das paredes). Nada invade o núcleo de 13; cápsula 4×10 nos trechos de corredor: 0 obstáculos de altura em 183 links.
- **Setor 3 — 3 landmarks naturais** (`Gameplay/NaturalLandmarks`): `S3_SplitTree` (170,−566) pinheiro duplo inclinado sobre montículo de raízes no bolsão (9,10); `S3_Monolith` (−135,−551) monólito de ardósia inclinado 26 studs com musgo no topo, na clareira (2,10); `S3_MossHollow` (−80,−600) bolsão (3,11) com chão de **Grass** (capim 3D do Terrain — descoberta: o material Grass gera lâminas; `Terrain.Decoration` está ativo) + 12 samambaias grandes + musgo nas paredes.
- **Antecâmara**: 16 mordidas de ar nas faces externas (oeste ×7, leste ×5, norte ×4, assimétricas), 18 blocos de rocha na base, ombros nos cantos sul, 30 crateras/saliências no topo; câmara, fenda do portão (14×12) e trilha intactas por voxel.
- **Correções**: abas planas de terreno fora do bloco (x ±302…±360, z −328…−392, resquício da faixa V2-B) removidas e regramadas; 36 pinheiros de cinturão nas bordas.
- **Incidente e lição**: uma auditoria de aterramento usou estimativa de superfície por ocupância de voxel (errada: piso lido a 0,4 em vez de 2,0) e afundou toda a vegetação; **restaurada do backup** e refeita com raycast (após o Terrain assentar): 61 rebaixados, 115 levantados, 44 removidos. Regra: aterrar só com raycast e só modelos de nível superior.
- Contagens: Workspace **5.909 → 4.617 BaseParts**, **5.630 → 4.335 MeshParts**, emissores 63 → 63, luzes 12 → 12; labirinto 1.328 pinheiros / 631 samambaias; acampamento 427 pinheiros.
